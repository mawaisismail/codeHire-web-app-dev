      ...
      <div className={styles.main_content}>
        ...
        <p className={styles.file_details}>
          <span className="truncate w-[120px]">
            {docs?.name ?? "Resume.pdf"}
          </span>
        </p>
      </div>
      {!upload ? (
        <div className="flex items-center gap-2">
          <a target={"_blank"} href={docs?.url ?? ""} rel="noreferrer">
          ...
          <button
            ...
            disabled={loading}
            className="bg-red-500 hover:bg-blue-700 text-white font-bold py-1  px-4 rounded-full relative"
          >
            Delete
          </button>
        </div>
        ...
        <div>
          <button
            onClick={onClick}
            disabled={loading}
            className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full relative"
          >
            {loading && (
              <svg
                aria-hidden="true"
