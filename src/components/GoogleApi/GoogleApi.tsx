    ...
    const Jobs: { position: { lat: number; lng: number }; label?: google.maps.MarkerLabel }[] = [
        {
        ...
        fetch(
            ...
            .then(async (data) => {
              if (data.status === "OK" && data.results.length > 0) {
                ...
                if (destinationRef.current) destinationRef.current.value = locationName;
            ...
            >
              ...
              <div className={styles.content}>
                  ...
                  <div className={styles.infoContainer}>
                      ...
                      <FaLocationArrow className={styles.icons} onClick={() => {
                          if (map) {
                              map.panTo(center);
                              map.setZoom(15);
                          }
